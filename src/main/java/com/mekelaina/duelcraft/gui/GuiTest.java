...
public class GuiTest extends GuiContainer
{
    ...
    private static final ResourceLocation BG_TEXTURE = new ResourceLocation(Reference.MOD_ID, "textures/gui/test.png");
    ...
    {
      //  String name = I18n.format(ModBlocks.KAIBALIUM_BLOCK.getUnlocalizedName() + ".name");
